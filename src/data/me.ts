...
export const me = {
  name: "Fachri Agustian Suhliandana",
  titles: [
    "Web Developer",
    "Frontend Developer",
    "Backend Developer",
  ...
  email: "Fachri.AgustianSuhliandana@gmail.com",
  phone: {
    display: "+62 085923261431",
    value: 085923261431,
  },
  experiences: [
    {
  ...
  educations: [
    {
      period: "2015 - 2019",
      University: "University Of Computer Indonesia",
